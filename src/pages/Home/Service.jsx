...
const Service = ({ eventCards }) => {
    ...
    return (
        <>
            <div className="absolute -top-8 lg:-top-[5%] px-10 py-4 lg:py-14 lg:w-[1200px] mx-auto bg-gray-800 rounded-br-full rounded-tl-full backdrop-filter backdrop-blur-sm bg-opacity-80" data-aos="flip-up" data-aos-duration="1000">
